...
public class HomepageActions_Uday1 {
  ...
  public void listingviewcompare(ExtentTest test) {
    try {
      helperObj2.waitForElementToBeVisible(ProductDetails_uday.list_viewproduct, 10);
      ...
      helperObj2.waitForElementToBeVisible(Products_FilterLocators_uday.compare1_product, 10);
      helperObj2.clickOnElement(Products_FilterLocators_uday.compare1_product);
      helperObj2.waitForElementToBeVisible(Products_FilterLocators_uday.compare2_product, 10);
      helperObj2.clickOnElement(Products_FilterLocators_uday.compare2_product);
      helperObj2.waitForElementToBeVisible(Products_FilterLocators_uday.compareproduct, 10);
  ...
  public void removingProducts(ExtentTest test) {
    try {
      ...
      helperObj2.waitForElementToBeVisible(Products_FilterLocators_uday.OKClick, 10);
