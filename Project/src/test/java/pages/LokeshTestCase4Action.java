...
public class LokeshTestCase4Action {
    ...
    public void NavBar_Batting_Gloves(ExtentTest test) {
        ...
        String expectedURL1 = ExcelFileReader.readExcelData(path, "Sheet1", 0, 0);
        ...
        String expectedheader1 = ExcelFileReader.readExcelData(path, "Sheet1", 7, 0);
    ...
    public void NavBar_Batting_Leg_Guards(ExtentTest test) {
        ...
        String expectedURL2 = ExcelFileReader.readExcelData(path, "Sheet1", 1, 0);
        ...
        String expectedheader2 = ExcelFileReader.readExcelData(path, "Sheet1", 8, 0);
    ...
    public void NavBar_Wicket_Keeping_Gloves(ExtentTest test) {
        ...
        String expectedURL3 = ExcelFileReader.readExcelData(path, "Sheet1", 2, 0);
        ...
        String expectedheader3 = ExcelFileReader.readExcelData(path, "Sheet1", 9, 0);
    ...
    public void NavBar_Wicket_Keeping_Leg_Guards(ExtentTest test) {
        ...
        String expectedURL4 = ExcelFileReader.readExcelData(path, "Sheet1", 3, 0);
        ...
        String expectedheader4 = ExcelFileReader.readExcelData(path, "Sheet1", 10, 0);
    ...
    public void NavBar_Circket_Helmets(ExtentTest test) {
        ...
        String expectedURL5 = ExcelFileReader.readExcelData(path, "Sheet1", 4, 0);
        ...
        String expectedheader5 = ExcelFileReader.readExcelData(path, "Sheet1", 11, 0);
    ...
    public void NavBar_Inner_Thigh_Pads(ExtentTest test) {
        ...
        String expectedURL6 = ExcelFileReader.readExcelData(path, "Sheet1", 5, 0);
        ...
        String expectedheader6 = ExcelFileReader.readExcelData(path, "Sheet1", 12, 0);
