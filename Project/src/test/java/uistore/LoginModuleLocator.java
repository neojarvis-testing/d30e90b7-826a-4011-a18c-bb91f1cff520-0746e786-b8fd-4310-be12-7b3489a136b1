...
public class LoginModuleLocator {
    ...
    public static By thankYouMessage = By.cssSelector("[data-bind='html: $parent.prepareMessageForHtml(message.text)']");
    ...
    public static By verifyErrorMessage = By.cssSelector("[data-bind='html: $parent.prepareMessageForHtml(message.text)']");
