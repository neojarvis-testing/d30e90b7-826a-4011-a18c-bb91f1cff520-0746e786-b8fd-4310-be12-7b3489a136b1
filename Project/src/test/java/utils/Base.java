...
public class Base {
    ...
    /**
     * @Created by Uday
     * @Description Opens the browser, sets up WebDriver with properties from the configuration file,
     *              and initializes browser settings such as maximized window, timeouts, and listeners.
     *
     * @param None
     * @return None
     */
