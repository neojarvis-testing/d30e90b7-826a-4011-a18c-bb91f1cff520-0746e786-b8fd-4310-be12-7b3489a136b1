...
public class Screenshot extends Base {
    ...
    /**
     * @Created by Priyanka
     * @Description Captures a screenshot and saves it with the provided filename and timestamp.
    ...
    /**
     * @Created by Priyanka
     * @Description Captures a screenshot with a highlighted element using the provided locator and saves it with the filename.
